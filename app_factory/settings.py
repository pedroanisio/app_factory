"""
Django settings for app_factory project.
...
SECRET_KEY = 'django-insecure-)c2i0ap9ds!v9zn1p)jzsb=(f#nm95477wr_0^+$r)xkpus%85'
...
WSGI_APPLICATION = 'app_factory.wsgi.application'
